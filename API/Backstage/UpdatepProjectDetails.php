...
if ($admin_level > 2) {
    ...
    PROJECT_ORIGINAL_PRICE_PER_PERSON = ?, PROJECT_MIN_NUM_OF_PEOPLE = ?, PROJECT_SUMMARY = ?, 
    PROJECT_DESCRIPITION = ?, FK_CATEGORY_ID_for_PJ = ?, FK_LOCATION_ID_for_PJ = ? WHERE PROJECT_ID = ?";
    ...
    $statement_query_project_details->bindParam(6, $edited_details->projectSummary);
    $statement_query_project_details->bindParam(7, $edited_details->projectDescription);
    $statement_query_project_details->bindParam(8, $edited_details->projectCategory);
    $statement_query_project_details->bindParam(9, $edited_details->projectDepartureLocation);
    $statement_query_project_details->bindParam(10, $project_id);
