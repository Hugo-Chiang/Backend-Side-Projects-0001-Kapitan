...
if (!$data_error) {
    ...
    if ($admin_level > 2) {
        ...
        if ($testing == 1) {
            ...
            $statement_update_order_details->bindParam(1, $edited_details->orderDetailAmount);
            $statement_update_order_details->bindParam(2, $edited_details->MCname);
            $statement_update_order_details->bindParam(3, $edited_details->MCphone);
            $statement_update_order_details->bindParam(4, $edited_details->MCemail);
            $statement_update_order_details->bindParam(5, $edited_details->ECname);
            $statement_update_order_details->bindParam(6, $edited_details->ECphone);
            $statement_update_order_details->bindParam(7, $edited_details->ECemail);
            $statement_update_order_details->bindParam(8, $edited_details->projectID);
            $statement_update_order_details->bindParam(9, $edited_details->bookingNumOfPeople);
